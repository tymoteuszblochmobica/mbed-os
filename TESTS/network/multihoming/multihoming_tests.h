...
#ifndef MBED_CONF_MULTIHOMING_INTERFACES_NUM
#define MBED_CONF_MULTIHOMING_INTERFACES_NUM    2
#endif
...
extern char interface_name[MBED_CONF_MULTIHOMING_INTERFACES_NUM][INTERFACE_NAME_LEN];
